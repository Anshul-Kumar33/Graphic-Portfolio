  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      <div 
        ...
        style={{
          backgroundImage: `url('https://readdy.ai/api/search-image?query=modern%20creative%20workspace%20with%20colorful%20design%20elements%2C%20graphic%20design%20studio%20setup%20with%20multiple%20screens%20displaying%20vibrant%20designs%2C%20color%20palettes%20scattered%20around%2C%20creative%20tools%20and%20sketches%2C%20professional%20lighting%2C%20inspiring%20atmosphere%2C%20flat%20lay%20photography%20style%20with%20geometric%20shapes%20and%20typography%20elements%2C%20clean%20and%20organized%20creative%20environment&width=1920&height=1080&seq=hero-designer-bg-001&orientation=landscape')`
        }}
      ></div>
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 animate-fadeInUp">
          I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-white" style={{fontFamily: 'script, cursive'}}>Anshul kumar</span>
        </h1>
